...
Khi có file nào đó thay đổi thì ở Tab Git này sẽ update ngay. Ta chỉ cần chọn `Ctrl+A` rồi `Space` để select all sau đó pust lên server Git để lưu trữ.

![](C:/Users/tandu/AppData/Local/RStudio/tmp/paste-B717C571.png)
